(ns mranderson048.orchard.v0v3v0.orchard.java
  "Makes the `## Initialization` block cleaner."
  {:author "Jeff Valk"}
  (:require [mranderson048.orchard.v0v3v0.orchard.misc :as util]
            [clojure.java.io :as io]
            [clojure.reflect :as r]
            [clojure.string :as str]
            [mranderson048.orchard.v0v3v0.dynapath.v0v2v5.dynapath.util :as dp])
...
(def source-info
  ...
  (if jdk-tools
    (do (require '[mranderson048.orchard.v0v3v0.orchard.java.parser :as src])
